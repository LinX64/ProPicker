package com.linx64.propicker.pro_image_picker.ui
...
import com.linx64.propicker.R
import com.linx64.propicker.pro_image_picker.ProPicker
import com.linx64.propicker.pro_image_picker.ProviderHelper
import com.linx64.propicker.pro_image_picker.model.ImageProvider
import com.linx64.propicker.util.D
...
internal class ProPickerActivity : AppCompatActivity() {
    ...
    private fun prepareGallery() {
        val d = if (providerHelper.isToCompress())
            D.showProgressDialog(this, getString(R.string.compressing), false)
        else D.showProgressDialog(this, getString(R.string.compressing), false)
